...
const LazySettingsOperationsPage = lazy(async (): Promise<{ default: () => ReactElement }> => {
    const pageModule = await import("@/pages/settings-operations.page")
    return {
        default: pageModule.SettingsOperationsPage,
    }
})

function SettingsOperationsRouteComponent(): ReactElement {
    return (
...
export const Route = createFileRoute("/settings-operations")({
    component: SettingsOperationsRouteComponent,
