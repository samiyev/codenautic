 ...
 */
type FormSelectFieldRules<TFormValues extends FieldValues, TName extends FieldPath<TFormValues>> = Omit<
 ...
 */
export interface IFormSelectFieldProps<TFormValues extends FieldValues, TName extends FieldPath<TFormValues>> {
    /** Контроллер формы. */
    ...
    return (
        <Controller
            ...
            render={({field, fieldState}): ReactElement => {
                                ...
                                const selectedKeys = selectedKey === undefined ? new Set<string>() : new Set([selectedKey])
                            ...
                            {props.options.map(
                                (option): ReactElement => {
                                    return (
                                        <SelectItem key={option.value} isDisabled={option.isDisabled} value={option.value}>
