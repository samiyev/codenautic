/**
 * Normalized error metadata exposed by Cerebras provider.
 */
export interface ICerebrasProviderErrorDetails {
    /**
...
/**
 * Error thrown by Cerebras provider after request normalization and retry evaluation.
 */
export class CerebrasProviderError extends Error {
     ...
     */
    public constructor(message: string, details: ICerebrasProviderErrorDetails) {
        super(message)
